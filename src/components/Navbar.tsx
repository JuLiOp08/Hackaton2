...
function Navbar() {
  return (
     <nav className="w-full bg-gray-100 shadow px-8 py-6 flex gap-8 items-center justify-center fixed top-0 left-0 z-50">
      ...
      <Link to="/expense_categories" className="px-3 py-1 rounded hover:bg-gray-300 font-semibold">Categories</Link>
      <Link to="/add_expense" className="px-3 py-1 rounded hover:bg-gray-300 font-semibold">Add Expense</Link>
